...
export function NewBatchFlow() {
  const [currentStep, setCurrentStep] = useState(0); // Reset to first step
  const [templateFile, setTemplateFile] = useState<File | null>(null);
  const [csvFile, setCsvFile] = useState<File | null>(null); // This will be used in the next step
  const [error, setError] = useState<string | null>(null); // Clear mock error
  ...
  return (
    <div className="flex flex-col gap-8 max-w-3xl mx-auto p-4 lg:p-6">
